...
namespace UniDecl.Editor.UIToolKit.Examples
{
    ...
    {
        private const string UeThemePath = "Assets/ThirdParty/UniDecl/Editor/UIToolKit/Themes/UE5Style.uss";
        private const string HybridThemePath = "Assets/ThirdParty/UniDecl/Editor/UIToolKit/Themes/UnityUEHybridStyle.uss";
        private const string DefaultThemePath = "Assets/ThirdParty/UniDecl/Editor/UIToolKit/Themes/DefaultStyle.uss";
        ...
        public void CreateGUI()
        {
            ...
            _manager.LoadStyleSheet(_activeThemePath);
